    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-purple-300 drop-shadow">🍽️ Signature Dishes</h1>

                <a href="{{ route('admin.signature-dishes.create') }}"
                        ...
                        <tr class="border-b border-white/5 hover:bg-white/10 transition">
                            ...
                            <td class="py-4 px-4">
                                <div class="flex space-x-3">
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('admin.signature-dishes.edit', $dish->id) }}"
                                       class="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-xl text-white text-sm">
                                        Edit
                                    </a>

                                    {{-- Delete --}}
                                    <form action="{{ route('admin.signature-dishes.destroy', $dish->id) }}"
                                          method="POST"
