<x-admin-layout>
    ...
    <div class="py-10 max-w-4xl mx-auto">
        ...
        <div class="flex justify-between mb-6">
            <h1 class="text-3xl font-bold text-purple-300 drop-shadow">➕ Create Signature Dish</h1>
        ...
        <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-xl">
            ...
            <form method="POST" action="{{ route('admin.signature-dishes.store') }}" enctype="multipart/form-data">
                @csrf
